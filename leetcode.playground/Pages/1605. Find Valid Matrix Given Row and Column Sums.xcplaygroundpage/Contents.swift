...
class Solution {
    ...
    func restoreMatrix(_ rowSum: [Int], _ colSum: [Int]) -> [[Int]] {
        ...
        var ans: [[Int]] = Array(repeating: Array(repeating: 0, count: colSum.count), count: rowSum.count)
...
let rowSum = [3,8], colSum = [4,7]
let solution = Solution()
let ans = solution.restoreMatrix(rowSum, colSum)
print(ans)
